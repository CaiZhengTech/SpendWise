...
export default function FinanceTracker() {
  ...
  const handleQuestionnaireSubmit = () => {
    if (validateUserData()) {
      ...
      saveData()
      toast({
        description: 'Welcome to SpendWise 💸! Your initial data has been saved.',
      })
    }
  }
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-wrap justify-between items-center">
            <div className="w-full md:w-1/3 text-center md:text-left">
              <h3 className="text-lg font-semibold mb-2">SpendWise 💸</h3>
              <p className="text-sm">Your personal finance companion</p>
            </div>
            <div className="w-full md:w-1/3 text-center mt-4 md:mt-0">
              <p className="text-sm">&copy; 2024 Cai Zheng - cjzheng@umass.edu</p>
            ...
            <div className="w-full md:w-1/3 text-center md:text-right mt-4 md:mt-0">
              <div className="flex justify-center md:justify-end space-x-4">
                <Button variant="ghost" size="icon" asChild>
                  <a href="https://github.com/caizhengTech/SpendWise" target="_blank" rel="noopener noreferrer">
                    <Github className="h-5 w-5" />
                    <span className="sr-only">GitHub</span>
                  </a>
                </Button>
                <Button variant="ghost" size="icon" asChild>
                  <a href="https://www.linkedin.com/in/cai-zheng/" target="_blank" rel="noopener noreferrer">
                    <Linkedin className="h-5 w-5" />
                    <span className="sr-only">LinkedIn</span>
                  </a>
                </Button>
                {/* <Button variant="ghost" size="icon" asChild>
                  <a href="https://www.caizheng.com" target="_blank" rel="noopener noreferrer">
        ...
        <DialogContent className="bg-white text-black max-w-3xl">
          ...
          <ScrollArea className="h-[400px] w-full rounded-md border p-4">
            <div className="space-y-4">
              ...
              <p>By accessing or using SpendWise, you agree to be bound by these Terms of Service. If you disagree with any part of the terms, you may not access the service. This web application is developed from scratch and maintained in its entirety by Cai Zheng</p>

              <h2 className="text-xl font-bold">2. Description of Service</h2>
              <p>SpendWise is a personal finance management tool designed to help users track their income, expenses, and financial goals. This service is provided for personal use only and should not be used for professional financial advice.</p>
              ...
              <p>SpendWise is the sole property of Cai Zheng. The service, including its original content, features, and functionality, is protected by international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.</p>

              <h2 className="text-xl font-bold">5. Prohibited Uses</h2>
              <p>You agree not to use SpendWise:</p>
              ...
              <p>If you have any questions about these Terms, please contact Cai Zheng at cjzheng@umass.edu.</p>

              <h2 className="text-xl font-bold">10. Copyright Notice</h2>
              <p>This web project is protected by copyright. You may not copy, modify, or distribute this work without explicit permission from the author, Cai Zheng. Any unauthorized use, reproduction, or distribution of this work may result in severe civil and criminal penalties, and will be prosecuted to the maximum extent possible under the law.</p>
            </div>
          </ScrollArea>
          <DialogFooter>
